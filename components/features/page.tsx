...
const Features = () => {
  return (
    <div className='w-full lg:p-10 sm:p-3'>
      <div className='w-full flex lg:flex-row sm:flex-col items-center gap-y-5'>
        <div className='md:w-[50%] sm:w-full'>
            <h2 className='text-secondary-10 md:text-4xl sm:text-3xl font-medium'>Who is Mymedicare for?</h2>
        </div>
        <div className='md:w-[50%] sm:w-full'>
                    ...
                    <div className="w-full h-full md:p-8 sm:p-4">
                        ...
                        <div className="">
                            <Image
                                ...
                                width={1200}
                                height={800}
                                className="w-full h-auto object-cover md:rounded-4xl sm:rounded-2xl"
                                quality={100}
                                priority
                            />
                        </div>
      ...
      <div className="w-full h-[100vh] md:flex sm:hidden relative rounded-4xl overflow-hidden">
            <Image
        ...
        <div className="md:my-20 sm:my-5 w-full">
            <h2 className="font-semibold md:text-4xl sm:text-2xl text-tertiary-1 text-center tracking-wide leading-relaxed">Simple steps to get to start <br />your health journey</h2>

            <div className=" w-full grid lg:grid-cols-3 sm:grid-cols-1 md:grid-cols-2 gap-10 md:mt-20 sm:mt-10">
                <div>
                    <Card
                        className="bg-secondary-5 w-full"
                    >
                        <div className="w-full p-2">
                            <h2 className="capitalize font-bold text-secondary-10 md:text-4xl sm:text-2xl">step<span className="text-secondary-5"> 01</span></h2>
                            <div className="md:mt-[30%] sm:mt-10 w-full">
                                <h2 className="text-tertiary-1 font-semibold capitalize md:text-2xl sm:text-lg">get the app</h2>
                            </div>
                            <div className="md:mt-10 sm:mt-5 border-t-2 border-secondary-6 w-full">
                ...
                <div>
                    ...
                    >
                        <div className="w-full p-2">
                            <h2 className="capitalize font-bold text-secondary-10 md:text-4xl sm:text-2xl">step<span className="text-secondary-5"> 02</span></h2>
                            <div className="md:mt-[30%] sm:mt-10 w-full">
                ...
                <div>
                    ...
                    >
                        <div className="w-full p-2">
                            <h2 className="capitalize font-bold text-secondary-10 md:text-4xl sm:text-2xl">step<span className="text-secondary-5"> 03</span></h2>
                            <div className="md:mt-[30%] sm:mt-10 w-full">
                                <h2 className="text-tertiary-1 font-semibold capitalize md:text-4xl sm:text-2xl ">monitor and archieve</h2>
                            </div>
                            <div className="md:mt-10 sm:mt-5 border-t-2 border-secondary-6 w-full">
